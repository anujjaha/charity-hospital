...
<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/doctor')) }}">
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/patient')) }}">
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/surgery')) }}">
