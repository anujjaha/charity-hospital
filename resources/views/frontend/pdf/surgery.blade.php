        ...
        <table cellpadding="0" cellspacing="0">
                    <tr class="information">
                        ...
                        <td colspan="2">
                            <table>
                                <tr style="text-align:center;line-height:1.6;">
                                    <td><h4 style="margin:0;">TREATMENT</h4></td>
                                </tr>
                                <tr>
                                	<td>
                                    	<table id="items">
            ...
            <tr>
                <td style="line-height: 1.4;font-size:13px;">
                    ...
                    ૧. આંખ ની તાપસ - ૨. દાંત ની સારવાર  - ૩. શરીર ના તમામ રોગો ની સારવાર ( ફિઝિશિયન ) ૪. નવજાત શિશુ ની સારવાર - ૫.પ્રસુતિગૃહ - ૬.લેબોરેટોરી , એક્સ રે , સોનોગ્રાફી - ૭.ફિઝિયોથેરાપી
                </td>
            </tr>
        </table>
    </div>
